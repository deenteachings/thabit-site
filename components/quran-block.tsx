  ...
  return (
    <section className="border-b border-border">
      <div className="mx-auto max-w-2xl px-6 py-24 text-center sm:py-32">
        <p className="section-label mb-12">Why we built this</p>
        <span
          className="mx-auto mb-12 block w-7 border-t border-border-strong"
          aria-hidden="true"
        />
        <p
          dir="rtl"
          lang="ar"
          className="arabic text-balance text-[20px] leading-[42px] text-primary"
        >
